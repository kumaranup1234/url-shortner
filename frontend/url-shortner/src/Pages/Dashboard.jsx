...
const Dashboard = () => {
    ...
    return (
        <div className="mb-16">
            <div>
                <h4 className="p-4 ml-4 text-sm sm:text-base">* Overall analytics of the short url. For analytics of individual clicks of a url, please visit <Link to="/links" className="font-bold underline">Links</Link> and clicks the stats button.</h4>
            </div>
