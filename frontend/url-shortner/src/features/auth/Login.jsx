            ...
            <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-xl dark:shadow-2xl border border-transparent dark:border-gray-700 p-8 mb-8 lg:mb-0 transition-all">
                <form onSubmit={handleLogin}>
                    ...
                    <div className="text-right mb-6">
                        <Link to="/reset" className="text-sm text-blue-600 hover:text-blue-800 dark:hover:text-blue-400 font-medium transition-colors">
                            Forgot password?
                        </Link>
                    </div>
                    ...
                    <p className="text-sm text-center text-gray-600 dark:text-gray-400">
                        ...
                        <Link to="/signup" className="font-medium text-blue-600 hover:text-blue-800 dark:hover:text-blue-400 transition-colors">
                            Create Account
                        </Link>
                    </p>
                </form>
